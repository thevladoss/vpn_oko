...
- [x] 01-02-PLAN.md — Доменное ядро: sealed/immutable модели, интерфейсы, usecases (CORE-01)
- [x] 01-03-PLAN.md — VpnBridge демультиплексор, мапперы DTO→entity, датасорсы (BRG-02, BRG-03)
...
- [x] 03-05-PLAN.md — Ирис: CustomPainter + AnimationController + ConnectionTimer (UI-01, UI-04, UI-06)
...
**Plans**: 4 plans
Plans:
- [ ] 06-01-PLAN.md — README на русском: запуск, mermaid-архитектура, open-source/своё, iOS, план интеграции core, ограничения (DOC-01, DOC-02, DOC-03, DOC-04)
- [ ] 06-02-PLAN.md — CI GitHub Actions (analyze+test, subosito/flutter-action@v2) + локальный self-validating прогон (DOC-04)
